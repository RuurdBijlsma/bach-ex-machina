...
def get_model(settings, n_notes):
    ...
    classifier = Sequential([
        Conv1D(144, kernel_size=2, padding="causal", activation="relu"),
        Conv1D(72, kernel_size=8, padding="causal", activation="relu"),
        BatchNormalization(),

        LSTM(288, input_shape=(settings.window_size, n_notes), return_sequences=True, dropout=0.2),
        LSTM(144, dropout=0.1),
